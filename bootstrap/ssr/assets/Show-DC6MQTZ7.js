...
import DeleteUserForm from "./DeleteUserForm-C3sKc2WM.js";
import LogoutOtherBrowserSessionsForm from "./LogoutOtherBrowserSessionsForm-DiBd1teD.js";
...
import TwoFactorAuthenticationForm from "./TwoFactorAuthenticationForm-BqvL2ta0.js";
import UpdatePasswordForm from "./UpdatePasswordForm-CIHt6RGn.js";
import UpdateProfileInformationForm from "./UpdateProfileInformationForm-Brp6Rq9Q.js";
...
import "./ActionSection-VPAMaknK.js";
...
import "./ActionMessage-D7qvabMp.js";
import "axios";
import "js-cookie";
import "./FormSection-DtCNjUcg.js";
  ...
  _push(ssrRenderComponent(_component_AppLayout, mergeProps({ title: "Profile" }, _attrs), {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        if (_ctx.$page.jetstream.canUpdateProfileInformation) {
          _push2(`<div${_scopeId}>`);
          _push2(ssrRenderComponent(_component_UpdateProfileInformationForm, {
            user: _ctx.$page.auth.user
        ...
        if (_ctx.$page.jetstream.canUpdatePassword) {
          _push2(`<div${_scopeId}>`);
        ...
        if (_ctx.$page.jetstream.canManageTwoFactorAuthentication) {
          _push2(`<div${_scopeId}>`);
        ...
        if (_ctx.$page.jetstream.hasAccountDeletionFeatures) {
          _push2(`<!--[-->`);
          _push2(ssrRenderComponent(_component_SectionBorder, null, null, _parent2, _scopeId));
        ...
        return [
          createVNode("div", null, [
            createVNode("div", { class: "max-w-7xl mx-auto py-10 sm:px-6 lg:px-8" }, [
              _ctx.$page.jetstream.canUpdateProfileInformation ? (openBlock(), createBlock("div", { key: 0 }, [
                createVNode(_component_UpdateProfileInformationForm, {
                  user: _ctx.$page.auth.user
                }, null, 8, ["user"]),
                createVNode(_component_SectionBorder)
              ])) : createCommentVNode("", true),
              _ctx.$page.jetstream.canUpdatePassword ? (openBlock(), createBlock("div", { key: 1 }, [
                createVNode(_component_UpdatePasswordForm, { class: "mt-10 sm:mt-0" }),
                createVNode(_component_SectionBorder)
              ])) : createCommentVNode("", true),
              _ctx.$page.jetstream.canManageTwoFactorAuthentication ? (openBlock(), createBlock("div", { key: 2 }, [
              ...
              _ctx.$page.jetstream.hasAccountDeletionFeatures ? (openBlock(), createBlock(Fragment, { key: 3 }, [
                createVNode(_component_SectionBorder),
